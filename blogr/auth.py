from flask import Blueprint, render_template, request, url_for, redirect, flash, session, get_flashed_messages, g
...
def register():
    if request.method == 'POST':
        ...
        if user_email == None:
            ...
            error = f'El correo {email} ya esta siendo utilizado'
...
def login():
    if request.method == 'POST':
        ...
        if user == None or not check_password_hash(user.password, password):
            error = f'El correo o la contraseña son incorrectos'
